...
>>>>>>> c7b238555a4b8b54158b793161d29f887b4b1d30
    ...
    #滑动条触发控制
    def movestep_1(self):
        self.ui.label_step_1.setText(str('步长：'+str(self.ui.slider_step_1.value())))
        self.ui.slider_step_3.setValue(self.ui.slider_step_1.value())
        self.control_thread.move_distance=self.ui.slider_step_1.value()
    def movestep_3(self):
        self.ui.label_step_3.setText(str('步长：'+str(self.ui.slider_step_3.value())))
    ...
    def movespeed_1(self):
        self.ui.label_speed_1.setText(str('转速：'+str(self.ui.slider_speed_1.value())))
    ...
    def movespeed_3(self):
        self.ui.label_speed_3.setText(str('转速：'+str(self.ui.slider_speed_3.value())))
...
>>>>>>> c7b238555a4b8b54158b793161d29f887b4b1d30
    ...
    def openpic(self,Filepath):
        directory = QtWidgets.QFileDialog.getOpenFileName(self, "选取图片文件","./", "All Files (*);;jpg文件 (*.jpg);;png文件 (*.png);;bmp文件 (*.bmp)") 
        qImg = cv2toQImage(cv2.imread(directory[0]))
        qImg = QtGui.QPixmap(qImg).scaled(self.ui.label_pic4.width(), self.ui.label_pic4.height())
