...
from PySide6.QtWidgets import QApplication, QSlider, QStyleOptionSlider, QStyle, QWidget, QFormLayout, \
    QLabel
...
class DemoWindow(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.slider1.valueChanged.connect(
            lambda v: self.label1.setText(str(v)))
        ...
        self.slider2.valueChanged.connect(
            lambda v: self.label2.setText(str(v)))
        ...
        self.slider3.valueChanged.connect(
            lambda v: self.label3.setText(str(v)))
        layout.addRow(self.label3, self.slider3)

        # 纵向反向显示
        self.label4 = QLabel('0', self)
        self.slider4 = ClickJumpSlider(
            Qt.Vertical, invertedAppearance=True, minimumHeight=200)
        self.slider4.valueChanged.connect(
            lambda v: self.label4.setText(str(v)))
